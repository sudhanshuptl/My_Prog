/***********************Function Prototype*****************/
int BinomialCoeff(int n,int r) //Basic Approch
int BinomialCoeff_Recur(int n,int r)//Recursive Approach
int BinomialCoeff_DynamicProgramming(int n,int r)//Using Dynamic Programming
